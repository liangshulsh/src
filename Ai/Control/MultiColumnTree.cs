...
// Created by : Burhanudin Ashari (red_moon@CodeProject) @ July 22, 2010 - (April 23, 2011 in C#).
...
namespace Ai.Control {
    ...
    /// </remarks>
    public class MultiColumnTree : System.Windows.Forms.Control {
        /// <summary>
	    ...
	    public class ColumnHeaderCollection : CollectionBase {
		    ...
		    public ColumnHeaderCollection(MultiColumnTree owner) : base() { _owner = owner; }
		    ...
		    internal event EventHandler<EventArgs> ColumnFilterChanged;
		    #endregion
			    ...
			    if (ch.EnableSorting) {
				    if (ch.SortOrder != SortOrder.None) {
					    foreach (ColumnHeader otherCH in List) {
						    if (!object.ReferenceEquals(otherCH, ch)) otherCH.SortOrder = SortOrder.None;
					    }
		    ...
		    private void columnItemsRelatedValueChanged(object sender, EventArgs e) { _owner.Invalidate(); }
		    private void columnCustomFormatChanged(object sender, EventArgs e) {
			    ColumnHeader ch = (ColumnHeader)sender;
			    if (ch.Format == ColumnFormat.Custom | ch.Format == ColumnFormat.CustomDateTime) _owner.Invalidate();
		    }
		    private void columnEnableFilterChanged(object sender, EventArgs e) {
			    if (ColumnFilterChanged != null) ColumnFilterChanged(sender, e);
		    }
		    #endregion
	    }
	    /// <summary>
	    ...
	    public class CheckedTreeNodeCollection : CollectionBase {
		    internal MultiColumnTree _owner;
		    public CheckedTreeNodeCollection(MultiColumnTree owner) : base() { _owner = owner; }
		    #region Public Events
		    public event EventHandler<CollectionEventArgs> Clearing;
		    public event EventHandler<CollectionEventArgs> AfterClear;
		    public event EventHandler<CollectionEventArgs> Inserting;
		    ...
		    #region Public Functions
            /// <summary>
            /// Gets a TreeNode object in the collection specified by its index.
            /// </summary>
            [Description("Gets a TreeNode object in the collection specified by its index.")]
		    public TreeNode this[int index] {
			    get {
				    if (index >= 0 & index < List.Count) return (TreeNode)List[index];
				    return null;
			    }
		    }
            /// <summary>
            /// Gets the index of a TreeNode object in the collection.
            /// </summary>
		    [Description("Gets the index of a TreeNode object in the collection.")]
		    public int IndexOf(TreeNode node) { return this.List.IndexOf(node); }
            /// <summary>
            /// Add a TreeNode object to the collection.
            /// </summary>
            ...
            /// <summary>
            /// Add a TreeNode collection to the collection.
            /// </summary>
            [Description("Add a TreeNode collection to the collection."), 
		        System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1062:ValidateArgumentsOfPublicMethods")]
		    internal void AddRange(TreeNodeCollection nodes) {
			    foreach (TreeNode node in nodes) this.Add(node);
		    }
            /// <summary>
            /// Remove a TreeNode object from the collection.
            /// </summary>
            ...
            /// <summary>
            /// Determine whether a TreeNode object exist in the collection.
            /// </summary>
		    ...
		    protected override void OnClear() {
			    foreach (TreeNode tn in List) tn.Checked = false;
			    if (Clearing != null) Clearing(this, new CollectionEventArgs(CollectionEventArgs.EventType.OnClear));
		    }
		    protected override void OnClearComplete() {
			    if (AfterClear != null) AfterClear(this, new CollectionEventArgs(CollectionEventArgs.EventType.OnClearComplete));
        ...
        /// <summary>
        /// Represent a collection of selected TreeNode objects in a MultiColumnTree.
        /// </summary>
        [Description("Represent a collection of selected TreeNode objects in a MultiColumnTree.")]
        public class SelectedTreeNodeCollection : CollectionBase {
            internal MultiColumnTree _owner;
            public SelectedTreeNodeCollection(MultiColumnTree owner) : base() { _owner = owner; }
            #region Public Events
            public event EventHandler<CollectionEventArgs> Clearing;
            public event EventHandler<CollectionEventArgs> AfterClear;
            public event EventHandler<CollectionEventArgs> Inserting;
	    ...
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> BeforeCheck;
	    /// <summary>
	    /// Occurs afetr tree node check box is checked.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> AfterCheck;
	    /// <summary>
	    /// Occurs before tree node is collapsed.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> BeforeCollapse;
	    /// <summary>
	    /// Occurs after tree node is collapsed.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> AfterCollapse;
	    /// <summary>
	    /// Occurs before tree node is expanded.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> BeforeExpand;
	    /// <summary>
	    /// Occurs after tree node is expanded.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> AfterExpand;
	    /// <summary>
	    /// Occurs before tree node label text is edited.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> BeforeLabelEdit;
	    /// <summary>
	    /// Occurs after tree node label text is edited.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> AfterLabelEdit;
	    /// <summary>
	    /// Occurs before tree node is selected.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> BeforeSelect;
	    /// <summary>
	    /// Occurs after tree node is selected.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> AfterSelect;
	    /// <summary>
	    /// Occurs when mouse pointer is hover a tree node.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> NodeMouseHover;
	    /// <summary>
	    /// Occurs when mouse pointer is leaving a tree node.
	    /// </summary>
	    public event EventHandler<TreeNodeEventArgs> NodeMouseLeave;
	    /// <summary>
	    /// Occurs when mouse button is pressed over a tree node.
	    /// </summary>
	    public event EventHandler<TreeNodeMouseEventArgs> NodeMouseDown;
	    /// <summary>
	    /// Occurs when mouse button is released over a tree node.
	    /// </summary>
	    public event EventHandler<TreeNodeMouseEventArgs> NodeMouseUp;
	    /// <summary>
        ...
        SelectedTreeNodeCollection _selectedNodes;
        ...
        CultureInfo _ci = Ai.Renderer.Drawing.en_us_ci;
        ...
        /// </summary>
        private static Bitmap _gBmp = new Bitmap(1, 1);
        /// <summary>
	    ...
	    #endregion
	    #region Core Engines.  Classes to handle all objects, key and mouse event handlers, and as a visual representation of an object associated with MultiColumnTree.
	    /// <summary>
	    ...
	    private class ColumnHeaderControl : System.Windows.Forms.Control {
		    ...
		    private class ColumnHost {
			    ...
			    public void draw(Graphics g) {
				    ...
				    if (_column.EnableSorting) {
					    switch (_column.SortOrder) {
						    case SortOrder.Ascending:
							    Ai.Renderer.Drawing.drawTriangle(g, sortSignLeft, _rect.Y + (int)((_rect.Height - 6) / 2), 
				    ...
				    if (_onMouseDown) Ai.Renderer.Column.drawPressedShadow(g, _rect, 3);
			    }
			    /// <summary>
			    ...
			    /// <param name="canDrop">Determine whether the column can be dropped on a location, default value = true.</param>
			    public void drawMoved(Graphics g, Rectangle rect, bool canDrop) {
				    ...
				    if (!canDrop) {
					    ...
					    g.DrawLine(new Pen(Color.White, 3), rectSign.X + 2, rectSign.Y + (int)(rectSign.Height / 2), 
                            rectSign.Right - 3, rectSign.Y + (int)(rectSign.Height / 2));
				    }
			    }
			    /// <summary>
		    ...
		    private class OptionControl : System.Windows.Forms.Control {
			    ...
			    private class ItemHost {
				    ...
				    public void draw(Graphics g) {
					    Rectangle chkRect = new Rectangle();
			    ...
			    private void OptionControl_Paint(object sender, System.Windows.Forms.PaintEventArgs e) {
				    ...
				    e.Graphics.DrawString("OK", this.Font, Ai.Renderer.Drawing.NormalTextBrush(), _btnRect, btnFormat);
				    btnFormat.Dispose();
			    }
		    }
		    // CheckBox control
		    ...
		    public Rectangle ColumnRectangle(ColumnHeader column) {
			    foreach (ColumnHost ch in _columnHosts) { if (ch.Column == column) return ch.Bounds; }
		    ...
		    public ColumnHeader[] FrozenColumns {
			    get {
		    ...
		    public ColumnHeader[] UnFrozenColumns {
			    get {
				    List<ColumnHeader> result = new List<ColumnHeader>();
				    foreach (ColumnHost ch in _columnHosts) {
					    if (ch.Column.Visible & !ch.Column.Frozen) result.Add(ch.Column);
		    ...
		    public Rectangle FrozenRectangle {
			    get {
				    ...
				    foreach (ColumnHost ch in _columnHosts) {
					    if (ch.Column.Visible & ch.Column.Frozen) {
						    if (leftMost == -1) { leftMost = ch.Bounds.X;
						    } else {
							    if (leftMost > ch.Bounds.X) leftMost = ch.Bounds.X;
						    }
						    if (rightMost < ch.Bounds.Right + 2) rightMost = ch.Bounds.Right + 2;
		    ...
		    /// </summary>
		    public ColumnFilterHandle[] FilterHandlers {
			    get {
		    ...
		    private void ColumnHeaderControl_Paint(object sender, System.Windows.Forms.PaintEventArgs e) {
			    ...
			    if (_owner._showColumnOptions) {
				    ...
				    Ai.Renderer.Drawing.drawTriangle(e.Graphics, _optRect, (this.Enabled ? Color.FromArgb(21, 66, 139) : System.Drawing.Color.Gray), Color.White, Ai.Renderer.Drawing.TriangleDirection.Down);
				    borderPen.Dispose();
			    }
			    if (_owner._checkBoxes) {
				    int reservedWidth = 0;
				    ...
				    Ai.Renderer.CheckBox.drawCheckBox(e.Graphics, _chkRect, _chkState, 14, this.Enabled, _chkHover);
				    borderPen.Dispose();
			    }
	    ...
	    private class TreeNodeHost {
		    ...
		    private class TreeNodeSubItemHost {
			    ...
			    public string getSubItemString() {
				    ...
				    if (index == 0) return _owner._node.Text;
			    ...
			    public void measureOriginal() {
				    if (!_owner._owner._performValidation) return;
				    string strSubitem = getSubItemString();
				    int index = _owner._node.SubItems.IndexOf(_subItem) + 1;
				    ColumnHeader aColumn = _owner._owner._columns[index];
				    if (aColumn != null) {
					    Font font = null;
					    if (_owner._node.UseNodeStyleForSubItems) font = _owner._node.NodeFont;
					    ...
					    if (index == 0) {
						    if (_owner._owner._showImages) _originalSize.Width += 20;
						    if (_owner._owner._checkBoxes) _originalSize.Width += 20;
					    }
					    if (aColumn.Format == ColumnFormat.Check) _originalSize.Height = 14 + (2 * MultiColumnTree._subItemMargin);
				    } else {
				    ...
				    if (aColumn != null) {
					    ...
					    if (index == 0) {
						    ...
						    if (colRect.Width <= _originalSize.Width) {
							    _displaySize = new Size((int)colRect.Width, (int)_originalSize.Height);
						    } else {
					    ...
					    if (!_owner._owner._allowMultiline) {
						    if (strSubitem.IndexOf("\n") > -1) {
							    ...
							    if (_owner._node.UseNodeStyleForSubItems) font = _owner.Node.NodeFont;
			    ...
			    public int Y {
				    ...
				    set {
					    ...
					    _checkBoxRect.Y = value + (int)((_owner._size.Height - 14) / 2);
				    }
			    }
			    /// <summary>
			    ...
			    public void draw(Graphics g, bool drawBackground, bool selected) {
				    ...
				    if (drawBackground) {
					    if (_onHover || selected) {
						    ...
						    if (_owner._node.UseNodeStyleForSubItems) g.FillRectangle(new SolidBrush(_owner._node.BackColor), rect);
				    ...
				    if (aColumn.Format == Control.ColumnFormat.Check) {
					    ...
					    rectCheck.Y = rectValue.Y + (int)((rectValue.Height - 14) / 2);
					    switch (aColumn.ColumnAlign) {
						    case HorizontalAlignment.Center:
							    rectCheck.X = rectValue.X + (int)((rectValue.Width - 14) / 2);
							    break;
						    case HorizontalAlignment.Left:
					    ...
					    if (checkValue) Ai.Renderer.CheckBox.drawCheck(g, rectCheck, CheckState.Checked, 14, _owner._owner.Enabled);
				    } else {
					    ...
					    if (index == 0) {
						    if (_owner._owner._checkBoxes) {
							    ...
							    if (_owner._onHover || _owner._node.CheckState != CheckState.Unchecked || _owner._selected)
								    Ai.Renderer.CheckBox.drawCheckBox(g, _checkBoxRect, _owner._node.CheckState, 14, _owner._owner.Enabled, _onHoverCheck);
						    }
						    if (_owner._owner._showImages) {
							    Image img = null;
							    if (_owner._node.IsExpanded) img = _owner._node.ExpandedImage;
							    if (img == null) img = _owner._node.Image;
							    if (img != null) {
								    Rectangle rectImg = new Rectangle(rectValue.Location, new Size(20, rectValue.Height));
								    rectImg = Ai.Renderer.Drawing.getImageRectangle(img, rectImg, 16);
								    if (_owner._owner.Enabled) g.DrawImage(img, rectImg);
								    else Ai.Renderer.Drawing.grayScaledImage(img, rectImg, g);
							    }
							    rectValue.X += 20;
							    rectValue.Width -= 20;
						    }
						    if (_owner.getVisibleChildCount() > 0) {
							    if (_owner._owner.Enabled) Ai.Renderer.Drawing.drawTriangle(g, _owner._dropDownRect, (_owner._onHoverDropDown ? System.Drawing.Color.Gold : System.Drawing.Color.Black), System.Drawing.Color.White, (_owner._node.IsExpanded ? Renderer.Drawing.TriangleDirection.DownRight : Renderer.Drawing.TriangleDirection.Right));
							    else Ai.Renderer.Drawing.drawTriangle(g, _owner._dropDownRect, System.Drawing.Color.Gray, System.Drawing.Color.White, (_owner._node.IsExpanded ? Renderer.Drawing.TriangleDirection.DownRight : Renderer.Drawing.TriangleDirection.Right));
						    }
					    }
		    ...
		    public TreeNodeHost(TreeNode node, MultiColumnTree owner, TreeNodeHost parentHost) {
			    ...
			    if (_node.Checked) _owner._checkedNodes.Add(_node);
			    refreshSubItem();
		    ...
		    public void relocateChildrenHosts() {
			    ...
			    foreach (TreeNodeHost tnHost in _childHosts) {
				    tnHost.Y = y;
				    if (tnHost.Visible) {
					    if (tnHost._node.IsExpanded) tnHost.relocateChildrenHosts();
					    y = tnHost.Bottom;
				    }
			    }
		    }
		    ...
		    /// </summary>
		    public void sortChildren(bool relocateChild) {
			    _childHosts.Sort(_owner.nodeHostComparer);
			    foreach (TreeNodeHost tnHost in _childHosts) tnHost.sortChildren(relocateChild);
			    if (relocateChild) relocateChildrenHosts();
		    }
            public void sortChildren() { sortChildren(true); }
		    /// <summary>
		    /// Filter the children host contained in this host, based on specified filter parameters.
		    /// </summary>
		    public void filterChildren(List<ColumnFilterHandle> handlers, bool relocateChild) {
			    foreach (TreeNodeHost tnHost in _childHosts) {
				    tnHost.Visible = _owner.filterNode(tnHost.Node, handlers);
				    if (tnHost.Visible) tnHost.filterChildren(handlers, relocateChild);
			    }
			    if (relocateChild) {
				    measureChildren();
            ...
            public void filterChildren(List<ColumnFilterHandle> handlers) { filterChildren(handlers, true); }
            public void filterChildren(ColumnFilterHandle[] handlers, bool relocateChild) {
                foreach (TreeNodeHost tnHost in _childHosts) {
                    tnHost.Visible = _owner.filterNode(tnHost.Node, handlers);
                    if (tnHost.Visible) tnHost.filterChildren(handlers, relocateChild);
                }
            ...
            public void filterChildren(ColumnFilterHandle[] handlers) { filterChildren(handlers, true); }
		    /// <summary>
		    /// Filter the children host contained in this host.
		    /// </summary>
		    public void filterChildren(bool relocateChild) {
			    ColumnFilterHandle[] handlers = _owner._columnControl.FilterHandlers;
			    filterChildren(handlers, relocateChild);
		    }
            public void filterChidlren() { filterChildren(true); }
		    /// <summary>
		    ...
		    public void removeHandlers() {
			    ...
			    if (_node.Checked) _owner._checkedNodes.Remove(_node);
			    foreach (TreeNodeHost tnHost in _childHosts) tnHost.removeHandlers();
		    }
		    /// <summary>
		    ...
		    public void collectSubItemValue(int index, List<object> values) {
			    if (index >= 0 & index <= _node.SubItems.Count) {
				    ...
				    if (subValue != null) {
					    if (!values.Contains(subValue)) values.Add(subValue);
				    }
			    }
			    foreach (TreeNodeHost tnHost in _childHosts) tnHost.collectSubItemValue(index, values);
		    }
		    /// <summary>
		    ...
		    public int getVisibleChildCount() {
			    int visibleCount = 0;
			    foreach (TreeNodeHost tnHost in _childHosts) {
				    if (tnHost.Visible) visibleCount += 1;
			    }
			    return visibleCount;
		    }
		    /// <summary>
		    ...
		    public TreeNodeHost getPrevHost(TreeNodeHost fromHost) {
			    ...
			    if (hostIndex == 0) {
				    ...
				    hostIndex -= 1;
				    while (hostIndex >= 0) {
					    if (_childHosts[hostIndex].Visible) return _childHosts[hostIndex];
					    hostIndex += 1;
				    }
			    }
			    return null;
		    ...
		    public TreeNodeHost getNextHost(TreeNodeHost from) {
			    if (getVisibleChildCount() == 0) return null;
			    int hostIndex = _childHosts.IndexOf(from);
			    if (from == this) hostIndex = 0;
		    ...
		    /// </summary>
		    public TreeNodeHost getNextHost(TreeNodeHost from, string startsWith, bool startNextNode) {
			    if (getVisibleChildCount() == 0) return null;
			    int hostIndex = _childHosts.IndexOf(from);
			    if (from == this) {
				    hostIndex = 0;
				    if (!startNextNode) {
					    // Checking own node
					    if (_node.Text.StartsWith(startsWith, StringComparison.OrdinalIgnoreCase)) return this;
					    if (getVisibleChildCount() == 0 || !_node.IsExpanded) return null;
				    }
			    }
			    while (hostIndex < _childHosts.Count) {
				    if (_childHosts[hostIndex].Visible) {
					    if (_childHosts[hostIndex]._node.Text.StartsWith(startsWith, StringComparison.OrdinalIgnoreCase)) {
						    ...
						    if (_childHosts[hostIndex].getVisibleChildCount() > 0 && _childHosts[hostIndex]._node.IsExpanded) {
							    ...
							    result = _childHosts[hostIndex].getNextHost(_childHosts[hostIndex], startsWith, true);
            ...
            public TreeNodeHost getNextHost(TreeNodeHost from, string startsWith) { return getNextHost(from, startsWith, true); }
		    /// <summary>
		    ...
		    public TreeNodeHost getLastVisibleNode() {
			    if (_node.IsExpanded && getVisibleChildCount() > 0) {
				    ...
				    while (i >= 0) {
					    if (_childHosts[i].Visible) return _childHosts[i].getLastVisibleNode();
					    i -= 1;
				    }
			    }
			    return this;
		    ...
		    public TreeNodeHost getTopParentHost() {
			    if (_parentHost == null) return this;
			    TreeNodeHost pHost = _parentHost;
			    while (pHost != null) {
				    if (pHost.ParentHost == null) return pHost;
		    ...
		    public TreeNodeHost getParentHost(TreeNode node) {
			    ...
			    while (pHost != null) {
				    if (pHost.Node == node) return pHost;
				    pHost = pHost.ParentHost;
			    }
			    return null;
		    }
		    ...
		    public void relocateSubItems() {
			    foreach (TreeNodeSubItemHost lvsiHost in _subItemHosts) lvsiHost.moveX();
		    }
		    // Drawing
		    /// <summary>
		    ...
		    private void drawBar(Graphics g, Rectangle rect, TreeNode.TreeNodeSubItem subItem, ColumnHeader column) {
			    if (column.MaximumValue > column.MinimumValue) {
				    ...
				    pathBar = Ai.Renderer.Drawing.roundedRectangle(rectBar, 2, 2, 2, 2);
		    ...
		    public void drawUnFrozen(Graphics g, int frozenCount) {
			    ...
			    if (_owner._fullRowSelect) {
				    if (_selected || _onHover) {
                        ...
                        if (_owner._columnControl.FrozenColumns.Length == 0) {
                            unfrozenRect = new Rectangle(1, _location.Y, _owner.Width - (_owner._vScroll.Width + 3), _size.Height);
                        }
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) tnHost.drawUnFrozen(g, frozenCount);
			    }
		    }
		    /// <summary>
		    ...
		    public void drawFrozen(Graphics g, int frozenCount) {
			    if (!_visible) return;
			    ...
			    if (_owner._fullRowSelect) {
				    if (_selected || _onHover) {
					    ...
					    frozenRect.Width -= 1;
                        if (frozenRect.X > 1) {
                            int d = frozenRect.X - 1;
                            frozenRect.X = 1;
                            frozenRect.Width += d;
                        }
					    GraphicsPath frozenPath = Ai.Renderer.Drawing.roundedRectangle(frozenRect, 2, (uint)(frozenCount > 0 ? 0 : 2), 2, (uint)(frozenCount > 0 ? 0 : 2));
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) tnHost.drawFrozen(g, frozenCount);
			    }
		    }
            /// <summary>
            ...
            public void drawDrag(Graphics g) {
                Rectangle rc;
                if (_owner._selectedNodes.Count == 1) {
                ...
                if (_node.Image != null) {
                    Rectangle rImg = Renderer.Drawing.getImageRectangle(_node.Image, rc, (int)(rc.Width - 4));
                    g.DrawImage(_node.Image, rImg);
                }
                if (_owner._selectedNodes.Count > 1) {
                    ...
                    rc.X += 4;
                    rc.Y += 4;
                    g.DrawString(_owner._selectedNodes.Count.ToString(), fn, Brushes.Black, rc, sf);
                    sf.Dispose();
                    fn.Dispose();
                }
            }
		    ...
		    public void measureSize() {
			    ...
			    _size.Height = height;
			    _dropDownRect.Y = _location.Y + (int)((height - 10) / 2);
		    }
		    /// <summary>
		    ...
		    public void measureChildren() {
			    ...
			    if (_node.IsExpanded) {
				    ...
				    foreach (TreeNodeHost tnHost in _childHosts) {
					    ...
					    if (tnHost.Visible) childrenHeight += tnHost.Bounds.Height;
				    }
				    ...
				    if (_node.IsExpanded) {
					    ...
					    foreach (TreeNodeHost tnHost in _childHosts) {
						    if (tnHost.Visible) {
							    ...
							    if (subSize.Width < childSize.Width) subSize.Width = childSize.Width;
						    }
					    }
				    }
			    }
		    ...
		    public SizeF getTextSize(int maxWidth, int maxHeight) {
			    ...
			    if (_owner._showImages) result.Width += 20;
		    ...
		    public int X {
			    ...
			    set {
				    _location.X = value;
				    relocateSubItems();
				    foreach (TreeNodeHost tnHost in _childHosts) tnHost.X = _location.X;
			    }
		    }
		    /// <summary>
		    ...
		    public int Y {
			    ...
			    set {
				    ...
				    _location.Y = value;
				    _dropDownRect.Y = _location.Y + (int)((_size.Height - 10) / 2);
				    foreach (TreeNodeSubItemHost siHost in _subItemHosts) siHost.Y = _location.Y;
				    foreach (TreeNodeHost tnHost in _childHosts) tnHost.Y += dy;
			    }
		    }
		    /// <summary>
		    /// Determine the location of the TreeNodeHost.
		    /// </summary>
		    [Description("Determine the location of the host in ListView." + "This location can be determined by ListView itself, or by the GroupHost where this item is attached.")]
		    ...
		    public bool IsVisible {
			    get {
				    ...
				    if (_parentHost != null) {
					    if (!_parentHost.IsVisible) return false;
					    if (!_parentHost.Node.IsExpanded) return false;
				    }
		    ...
		    /// </summary>
		    public TreeNodeHost ParentHost { get { return _parentHost; } }
		    ...
		    public bool mouseMove(MouseEventArgs e) {
			    if (!_visible) return false;
			    if (_location.X > _owner._clientArea.Right || _location.Y > _owner._clientArea.Bottom) return false;
			    if (Bottom < _owner._clientArea.Y || Right < _owner._clientArea.X) return false;
			    bool stateChanged = false;
			    TreeNodeSubItemHost subitemHover = null;
                ColumnHeader[] columns = _owner._columnControl.UnFrozenColumns;
			    int colIndex = 0;
			    int hoverIndex = -1;
			    ...
			    if (_owner._fullRowSelect) {
                    ...
                    Rectangle itemRect = new Rectangle(1, _location.Y, _owner.Width - (_owner._vScroll.Width + 3), _size.Height);
				    if (itemRect.Contains(e.Location) && e.X > _owner._clientArea.X && e.Y > _owner._clientArea.Y) {
						    ...
						    if (_dropDownRect.Contains(e.Location)) {
							    if (!_onHoverDropDown) {
                                    ...
                                    if (e.Button == MouseButtons.Left) {
                                        if (_node.IsExpanded) _node.collapse();
                                        else _node.expand();
                                    }
								    stateChanged = true;
							    }
					    ...
					    if (!_onHover) {
						    _owner.invokeNodeMouseHover(this);
						    _onHover = true;
						    if (_owner._nodeToolTip) {
							    if (Ai.Renderer.ToolTip.containsToolTip(_node.ToolTipTitle, _node.ToolTip, _node.ToolTipImage)) {
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) {
					    if (tnHost.Visible) stateChanged = stateChanged || tnHost.mouseMove(e);
				    }
			    }
			    return stateChanged;
		    }
		    ...
		    public bool mouseDown(MouseEventArgs e) {
				    ...
				    if (_owner._fullRowSelect) {
					    if (_onHoverDropDown && e.Button == System.Windows.Forms.MouseButtons.Left) {
						    ...
						    if (_subItemHosts[0].OnHoverCheck) {
							    ...
							    if (_owner._selectedHost != this || _owner._selectedNodes.Count > 1) {
								    ...
								    if (e.Button == System.Windows.Forms.MouseButtons.Left) _node.expand();
							    }
							    if (!_onMouseDown) {
								    _onMouseDown = true;
								    stateChanged = true;
			    ...
			    if (_onHoverDropDown && e.Button == System.Windows.Forms.MouseButtons.Left && !_owner._fullRowSelect) {
				    if (_node.IsExpanded) {
                       _node.collapse();
				    } else {
					    _node.expand();
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) {
					    if (tnHost.Visible) stateChanged = stateChanged || tnHost.mouseDown(e);
				    }
			    }
			    return stateChanged;
		    }
		    ...
		    public bool mouseUp(MouseEventArgs e) {
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) {
					    if (tnHost.Visible) stateChanged = stateChanged || tnHost.mouseUp(e);
				    }
			    }
			    return stateChanged;
		    }
		    ...
		    public bool mouseLeave() {
			    bool stateChanged = false;
			    foreach (TreeNodeSubItemHost tnsiHost in _subItemHosts) stateChanged = stateChanged || tnsiHost.mouseLeave();
			    ...
			    if (getVisibleChildCount() > 0 && _node.IsExpanded) {
				    foreach (TreeNodeHost tnHost in _childHosts) {
					    if (tnHost.Visible) stateChanged = stateChanged || tnHost.mouseLeave();
				    }
			    }
			    return stateChanged;
		    }
            ...
            /// <summary>
            /// Selects or deselects TreeNodeHost object determined by contained treenode.
            /// </summary>
            /// <param name="tn">TreeNode object to determine where the host must be selected or deselected.</param>
            /// <param name="selected">Determine whether the host is selected or deselected.</param>
            /// <returns>True if TreeNode object is found within the host or child hosts, false otherwise.</returns>
            public bool selectHost(TreeNode tn, bool selected) {
                if (tn == _node) {
                    _selected = selected;
                    if (_selected) {
                        _owner._selectedHost = this;
                    ...
                    foreach (TreeNodeHost ahost in _childHosts) {
                        if (ahost.selectHost(tn, selected)) return true;
                    }
                    return false;
                }
            }
            public bool selectHost(bool selected) {
                ...
                int i = 0;
                while (i < _childHosts.Count) {
                    _childHosts[i].selectHost(selected);
                    i++;
                }
                return changed;
            }
	    ...
	    private bool filterNode(TreeNode node) {
		    ...
		    if (_performValidation) {
			    ColumnFilterHandle[] handlers = _columnControl.FilterHandlers;
			    int i = 0;
			    while (i <= node.SubItems.Count && i < handlers.Length) {
        ...
        private bool filterNode(TreeNode node, ColumnFilterHandle[] handlers) {
            bool result = true;
            if (_performValidation) {
                int i = 0;
                while (i <= node.SubItems.Count && i < handlers.Length) {
	    ...
	    private void changeColumnCheckState() {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    if (tnHost.Node.CheckState == CheckState.Checked) checkedCount += 1;
			    else if (tnHost.Node.CheckState == CheckState.Indeterminate) indeterminateCount += 1;
		    }
		    if (checkedCount == _nodeHosts.Count) {
			    _columnControl.CheckState = CheckState.Checked;
		    } else {
			    if (checkedCount == 0) {
				    if (indeterminateCount == 0) _columnControl.CheckState = CheckState.Unchecked;
	    ...
	    private void sortAll() {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.sortChildren(false);
	    }
	    /// <summary>
	    /// Measure all existing hosts, and the client area used to display all hosts.
	    /// </summary>
	    private void measureAll() {
		    if (!_performValidation) return;
            try {
                ...
                foreach (TreeNodeHost tnHost in _nodeHosts) {
                    if (tnHost.Visible) itemsHeight += tnHost.Bounds.Height + 1;
                }
                _clientArea.X = 1;
	    ...
	    private void relocateAll() {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    ...
			    if (tnHost.Visible) y = tnHost.Bounds.Bottom + 1;
		    }
	    }
	    /// <summary>
	    ...
	    private void setSelectedHost(TreeNodeHost host) {
            ...
            _selectedHost = host;
            /*if (System.Windows.Forms.Control.ModifierKeys != Keys.Control) _selectedNodes.Clear();
            if (host != null) {
                if (!_selectedNodes.Contains(host.Node)) _selectedNodes.Add(host.Node);
                else _selectedNodes.Remove(host.Node);
            }*/
		    if (selectedHostChanged) {
			    if (_selectedHost != null)
				    if (AfterSelect != null) AfterSelect(this, new TreeNodeEventArgs(_selectedHost.Node, TreeNodeAction.Unknown));
			    if (SelectedNodeChanged != null) SelectedNodeChanged(this, new EventArgs());
		    }
	    }
        /// <summary>
        /// Sets the selected TreeNodeHost from property to a specified TreeNodeHost.
        /// </summary>
        private void setSelectedHostFromProperty(TreeNodeHost host) {
            bool selectedHostChanged = false;
            if (_selectedHost == null) selectedHostChanged = true;
            if (_selectedHost != host) selectedHostChanged = true;
            if (_selectedHost != null) _selectedHost.Selected = false;
	    ...
	    /// </summary>
	    private void invokeNodeMouseHover(TreeNodeHost host) {
            _hoverHost = host;
            if (NodeMouseHover != null) NodeMouseHover(this, new TreeNodeEventArgs(host.Node, TreeNodeAction.MouseHover));
	    }
	    /// <summary>
	    /// Raise the NodeMouseLeave event.
	    /// </summary>
	    private void invokeNodeMouseLeave(TreeNode node) {
            if (NodeMouseLeave != null) NodeMouseLeave(this, new TreeNodeEventArgs(node, TreeNodeAction.MouseLeave));
	    }
	    /// <summary>
	    /// Raise the NodeMouseDown event.
	    /// </summary>
	    private void invokeNodeMouseDown(TreeNode node, MouseEventArgs e) {
		    if (NodeMouseDown != null) NodeMouseDown(this, new TreeNodeMouseEventArgs(node, TreeNodeAction.MouseDown, e));
	    }
	    /// <summary>
	    /// Raise the NodeMouseUp event.
	    /// </summary>
	    private void invokeNodeMouseUp(TreeNode node, MouseEventArgs e) {
		    if (NodeMouseUp != null) NodeMouseUp(this, new TreeNodeMouseEventArgs(node, TreeNodeAction.MouseDown, e));
	    }
	    /// <summary>
	    ...
	    private void collapseAllChild(TreeNode node) {
		    ...
		    foreach (TreeNode tn in node.Nodes) {
			    tn._collapse();
			    if (tn.Nodes.Count > 0) collapseAllChild(tn);
		    }
		    if (changeInternalThread) _internalThread = false;
	    }
	    /// <summary>
	    ...
	    private void expandAllChild(TreeNode node) {
		    ...
		    foreach (TreeNode tn in node.Nodes) {
			    tn._expand();
			    if (tn.Nodes.Count > 0) expandAllChild(tn);
		    }
		    if (changeInternalThread) _internalThread = false;
	    }
	    /// <summary>
	    ...
	    private void checkNodeCheckedState(TreeNode node) {
		    ...
		    int indeterminateCount = 0;
		    foreach (TreeNode tn in node.Nodes) {
			    if (tn.CheckState == CheckState.Checked) checkedCount += 1;
			    if (tn.CheckState == CheckState.Indeterminate) indeterminateCount += 1;
		    }
		    if (checkedCount == 0 & indeterminateCount == 0) node.setCheckState(CheckState.Unchecked);
		    else if (checkedCount == node.Nodes.Count) node.setCheckState(CheckState.Checked);
		    else node.setCheckState(CheckState.Indeterminate);
		    if (node.Parent != null) checkNodeCheckedState(node.Parent);
	    }
	    /// <summary>
	    ...
	    private void changeChildrenChecked(TreeNode node) {
		    foreach (TreeNode tn in node.Nodes) {
			    ...
			    if (tn.Nodes.Count > 0) changeChildrenChecked(tn);
		    }
	    }
	    /// <summary>
	    ...
	    private TreeNodeHost selectPrevNodeHost() {
		    if (_nodeHosts.Count == 0) return null;
		    if (_selectedHost == null) return null;
		    if (_selectedHost.ParentHost != null) {
			    ...
			    while (hostIndex >= 0) {
				    if (_nodeHosts[hostIndex].Visible) return _nodeHosts[hostIndex].getLastVisibleNode();
				    hostIndex -= 1;
			    }
		    }
		    return null;
	    ...
	    private TreeNodeHost selectNextNodeHost() {
		    if (_nodeHosts.Count == 0) return null;
		    if (_selectedHost == null) return null;
		    if (_selectedHost.getVisibleChildCount() > 0 && _selectedHost.Node.IsExpanded) return _selectedHost.getNextHost(_selectedHost);
		    ...
		    while (i < _nodeHosts.Count) {
			    if (_nodeHosts[i].Visible) return _nodeHosts[i];
			    i += 1;
		    }
		    return null;
	    }
	    ...
	    private TreeNodeHost selectLastNodeHost() {
		    ...
		    while (i >= 0) {
			    if (_nodeHosts[i].Visible) return _nodeHosts[i].getLastVisibleNode();
			    i -= 1;
		    }
		    return null;
	    }
	    ...
	    private void ensureVisible(TreeNodeHost nodeHost) {
		    ...
		    if (!nodeHost.Visible) return;
		    int dx = 0;
		    int dy = 0;
		    if (nodeHost.X < _clientArea.X || nodeHost.Right > _clientArea.Right) {
			    if (nodeHost.X < _clientArea.X) dx = nodeHost.X - _clientArea.X;
			    else dx = nodeHost.Right - _clientArea.Right;
		    }
		    if (nodeHost.Y < _clientArea.Y || nodeHost.Bottom > _clientArea.Bottom) {
			    if (nodeHost.Y < _clientArea.Y) dy = nodeHost.Y - _clientArea.Y;
			    else dy = nodeHost.Bottom - _clientArea.Bottom;
		    }
	    ...
	    private void collectFilter(TreeNode aNode, int columnIndex, ColumnFilterHandle filterHandler) {
		    if (columnIndex >= 0 & columnIndex < _columns.Count) {
			    if (columnIndex <= aNode.SubItems.Count) filterHandler.addFilter(aNode.SubItems[columnIndex].Value);
			    if (aNode.Nodes.Count > 0 & aNode.IsExpanded) {
				    foreach (TreeNode node in aNode.Nodes) collectFilter(node, columnIndex, filterHandler);
			    }
		    }
	    }
	    /// <summary>
	    ...
	    private void collectFilter(int columnIndex, ColumnFilterHandle filterHandler) {
		    if (columnIndex >= 0 & columnIndex < _columns.Count) {
			    ...
			    if (_nodes.Count > 0) {
				    foreach (TreeNode node in _nodes) collectFilter(node, columnIndex, filterHandler);
			    }
		    }
	    }
	    #endregion
	    ...
	    internal void _nodeTextChanged(TreeNode node) {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    foundHost = tnHost.getHost(node);
			    if (foundHost != null) nodeHost = foundHost;
	    ...
	    internal void _nodeFontChanged(TreeNode node) {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    foundHost = tnHost.getHost(node);
			    if (foundHost != null) break; // TODO: might not be correct. Was : Exit For
		    }
	    ...
	    internal void _nodeBackColorChanged(TreeNode node) {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    foundHost = tnHost.getHost(node);
			    if (foundHost != null) {
				    if (foundHost.IsVisible) this.Invalidate();
				    return;
			    }
		    }
	    }
	    ...
	    internal void _nodeUseNodeStyleForSubItemsChanged(TreeNode node) { _nodeFontChanged(node); }
	    ...
	    internal void _nodeBeforeCheck(TreeNode node, TreeNodeEventArgs e) {
		    if (BeforeCheck != null) BeforeCheck(this, e);
	    }
	    ...
	    internal void _nodeChecked(TreeNode node) {
		    ...
		    if (AfterCheck != null) AfterCheck(this, new TreeNodeEventArgs(node, TreeNodeAction.Checked));
		    if (node.Parent != null) checkNodeCheckedState(node.Parent);
		    if (node.Nodes.Count > 0) changeChildrenChecked(node);
		    TreeNodeHost foundHost = null;
		    foreach (TreeNodeHost tnHost in _nodeHosts) {
			    foundHost = tnHost.getHost(node);
			    if (foundHost != null) break; // TODO: might not be correct. Was : Exit For
	    ...
	    internal void _nodeCollapsed(TreeNode node, bool ignoreChildren) {
		    if (AfterCollapse != null) AfterCollapse(this, new TreeNodeEventArgs(node, TreeNodeAction.Collapse));
		    if (!ignoreChildren) collapseAllChild(node);
        ...
        internal void _nodeCollapsed(TreeNode node) { _nodeCollapsed(node, true); }
	    ...
	    internal void _nodeExpanded(TreeNode node, bool ignoreChildren) {
		    if (AfterExpand != null) AfterExpand(this, new TreeNodeEventArgs(node, TreeNodeAction.Expand));
		    if (!ignoreChildren) expandAllChild(node);
		    if (_internalThread) return;
		    measureAll();
		    relocateAll();
		    this.Invalidate();
	    }
        internal void _nodeExpanded(TreeNode node) { _nodeExpanded(node, true); }
	    ...
	    internal void _subitemFontChanged(TreeNode.TreeNodeSubItem subitem) {
		    if (subitem.TreeNode.UseNodeStyleForSubItems) return;
	    ...
	    // Behavior
        /// <summary>
        /// Gets the collection of ColumnHeader that are assigned to the MultiColumnTree control
        /// </summary>
        ...
        /// <summary>
        /// Gets the collection of TreeNode that are assigned to the MultiColumnTree control
        /// </summary>
        ...
        /// <summary>
        /// Gets the collection of checked TreeNode that are assigned to the MultiColumnTree control
        /// </summary>
        ...
        /// <summary>
        /// Gets the collection of selected TreeNode of the MultiColumnTree control.
        /// </summary>
        [Browsable(false), Description("Gets the collection of selected TreeNode of the MultiColumnTree control.")]
        public SelectedTreeNodeCollection SelectedNodes {
            get { return _selectedNodes; }
        }
        /// <summary>
        /// Determine whether the user can edit the labels of nodes in the control
        /// </summary>
	    ...
	    // Appearance
        /// <summary>
        /// Determine a check box appears next to each node in the control
        /// </summary>
        ...
        /// <summary>
        /// Determine whether multiline node's text and subitem's value is allowed
        /// </summary>
        ...
        /// <summary>
        /// Determine the delimiter string that the tree node path uses
        /// </summary>
        ...
        /// <summary>
        /// Determine whether Images are shown on each TreeNode
        /// </summary>
        ...
        /// <summary>
        /// Determine the distance to indent each of the child tree node levels
        /// </summary>
	    ...
	    public TreeNode SelectedNode {
		    get {
			    if (_selectedHost == null) return null;
			    else return _selectedHost.Node;
		    }
		    set {
			    if (_selectedHost != null) {
				    if (_selectedHost.Node == value) return;
			    }
			    ...
			    if (foundHost != null) {
				    ...
				    if (BeforeSelect != null) BeforeSelect(this, beforeSelect);
				    if (beforeSelect.Cancel) return;
				    foundHost.expandAllParent();
                    setSelectedHostFromProperty(foundHost);
				    ensureVisible(_selectedHost);
				    this.Invalidate();
			    } else {
				    if (value == null) {
        ...
        /// </summary>
        [DefaultValue(false), Description("Gets or sets a value indicating whether lines are drawn between the tree nodes that are at the root of the tree view.")]
        ...
        /// </summary>
        [DefaultValue(false), Description("Gets or sets a value indicating whether lines are drawn between the tree nodes.")]
        public bool ShowNodeLines {
            get { return _showNodeLines; }
            set {
                if (_showNodeLines != value) {
        ...
        /// </summary>
        [DefaultValue(false), Description("Gets or sets a value indicating whether drag bitmap is drawn by your code.")]
	    ...
	    public MultiColumnTree() {
            ...
            _selectedNodes = new SelectedTreeNodeCollection(this);
            ...
            _columns.ColumnFilterChanged += _columns_ColumnFilterChanged;
            ...
            _selectedNodes.AfterInsert += _selectedNodes_AfterInsert;
            _selectedNodes.AfterRemove += _selectedNodes_AfterRemove;
            _selectedNodes.AfterClear += _selectedNodes_AfterClear;
            ...
            this.AllowDrop = true;
            this.Resize += MultiColumnTree_Resize;
            this.Paint += MultiColumnTree_Paint;
            this.MouseWheel += MultiColumnTree_MouseWheel;
            this.MouseUp += MultiColumnTree_MouseUp;
            this.MouseMove += MultiColumnTree_MouseMove;
            this.MouseLeave += MultiColumnTree_MouseLeave;
            this.MouseDown += MultiColumnTree_MouseDown;
            this.LostFocus += MultiColumnTree_LostFocus;
            this.KeyPress += MultiColumnTree_KeyPress;
            this.KeyDown += MultiColumnTree_KeyDown;
            this.GotFocus += MultiColumnTree_GotFocus;
            this.FontChanged += MultiColumnTree_FontChanged;
            this.EnabledChanged += MultiColumnTree_EnabledChanged;
            this.Disposed += MultiColumnTree_Disposed;
            // Drag drop operation.
            this.DragEnter += MultiColumnTree_DragEnter;
            this.DragLeave += MultiColumnTree_DragLeave;
            this.DragOver += MultiColumnTree_DragOver;
            this.DragDrop += MultiColumnTree_DragDrop;
	    }
	    protected override bool IsInputKey(System.Windows.Forms.Keys keyData) {
		    switch (keyData) {
			    case Keys.Up:
	    ...
	    public void collapseAll() {
		    _internalThread = true;
		    foreach (TreeNode tn in _nodes) tn.collapse(false);
	    ...
	    public Rectangle getNodeRectangle(TreeNode node) {
		    ...
		    if (node != null) {
			    ...
			    if (tnHost != null) result = tnHost.Bounds;
		    }
		    return result;
	    }
	    #endregion
	    #region Event Handlers
        private void _selectedNodes_AfterRemove(object sender, CollectionEventArgs e) {
            TreeNode tn = (TreeNode)e.Item;
            bool changed = false;
            foreach (TreeNodeHost tnHost in _nodeHosts) {
                if (tnHost.selectHost(tn, false)) {
                    changed = true;
                    break;
                }
            }
            if (_selectedHost != null) {
                ...
                if (_selectedNodes.Count > 0) {
                    foreach (TreeNodeHost tnHost in _nodeHosts) {
                        if (tnHost.selectHost(_selectedNodes[_selectedNodes.Count - 1], true)) break;
                    }
                }
            }
            if (changed && !_internalThread) this.Invalidate();
        }
        private void _selectedNodes_AfterInsert(object sender, CollectionEventArgs e) {
            TreeNode tn = (TreeNode)e.Item;
            bool changed = false;
            foreach (TreeNodeHost tnHost in _nodeHosts) {
                if (tnHost.selectHost(tn, true)) {
                    changed = true;
                    break;
                }
            }
        ...
        private void _selectedNodes_AfterClear(object sender, CollectionEventArgs e) {
            bool changed = false;
            int i = 0;
            while (i < _nodeHosts.Count) {
                _nodeHosts[i].selectHost(false);
                i++;
            }
	    ...
	    private void _nodes_AfterClear(object sender, CollectionEventArgs e) {
		    setSelectedHost(null);
		    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.removeHandlers();
		    _nodeHosts.Clear();
	    ...
	    private void _hScroll_ValueChanged(object sender, System.EventArgs e) {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.X = _clientArea.X - _hScroll.Value;
		    this.Invalidate(true);
	    }
	    private void _vScroll_ValueChanged(object sender, System.EventArgs e) {
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.Y += dy;
	    ...
	    private void _columnControl_AfterColumnCustomFilter(object sender, ColumnEventArgs e) {
		    ...
		    if (!cEvent.CancelFilter) {
			    ...
			    foreach (TreeNodeHost tnHost in _nodeHosts) {
				    ...
				    if (tnHost.Visible) tnHost.filterChildren(handlers, false);
			    }
			    if (_selectedHost != null) {
				    if (!_selectedHost.Visible) setSelectedHost(null);
			    }
			    measureAll();
			    relocateAll();
			    this.Invalidate();
	    ...
	    private void _columnControl_CheckedChanged(object sender, System.EventArgs e) {
		    _internalThread = true;
		    foreach (TreeNode tn in _nodes) tn.Checked = _columnControl.CheckState == CheckState.Checked;
		    this.Invalidate();
		    _internalThread = false;
	    }
				    ...
				    if (!_txtEditor.Multiline) {
					    if (_currentEditedHost != null) {
						    if (_currentEditedHost.Node.Text != _txtEditor.Text) {
							    ...
							    if (AfterLabelEdit != null) AfterLabelEdit(this, new TreeNodeEventArgs(_currentEditedHost.Node, TreeNodeAction.LabelEdit));
						    }
					    }
					    this.Focus();
				    }
	    ...
	    private void MultiColumnTree_EnabledChanged(object sender, System.EventArgs e) { this.Invalidate(); }
	    private void MultiColumnTree_FontChanged(object sender, System.EventArgs e) {
		    measureAll();
		    relocateAll();
		    this.Invalidate();
	    }
	    private void MultiColumnTree_GotFocus(object sender, System.EventArgs e) { this.Invalidate(); }
	    private void MultiColumnTree_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e) {
		    switch (e.KeyCode) {
			    case Keys.Up:
				    TreeNodeHost upperHost = null;
				    if (_selectedHost != null) upperHost = selectPrevNodeHost();
				    else upperHost = selectFirstNodeHost();
				    if (upperHost != null) {
					    TreeNodeEventArgs bfrSelect = new TreeNodeEventArgs(upperHost.Node, TreeNodeAction.Unknown);
					    if (BeforeSelect != null) BeforeSelect(this, bfrSelect);
					    if (bfrSelect.Cancel) return;
			    ...
			    case Keys.Down:
				    ...
				    if (_selectedHost != null) lowerHost = selectNextNodeHost();
				    else lowerHost = selectFirstNodeHost();
				    if (lowerHost != null) {
			    ...
			    case Keys.Right:
				    ...
				    break;
			    case Keys.Home:
				    TreeNodeHost fHost = selectFirstNodeHost();
				    if (fHost != null) {
					    TreeNodeEventArgs bfrSelect = new TreeNodeEventArgs(fHost.Node, TreeNodeAction.Unknown);
					    if (BeforeSelect != null) BeforeSelect(this, bfrSelect);
					    if (bfrSelect.Cancel) return;
					    setSelectedHost(fHost);
					    if (_selectedHost != null) {
						    ensureVisible(_selectedHost);
						    this.Invalidate();
					    }
			    ...
			    case Keys.F2:
				    ...
				    if (BeforeLabelEdit != null) BeforeLabelEdit(this, lblEditEvent);
				    if (lblEditEvent.Cancel) return;
				    ensureVisible(_selectedHost);
				    this.Invalidate();
	    ...
	    private void MultiColumnTree_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e) {
		    ...
		    if (nextHost != null && nextHost != _selectedHost) {
			    TreeNodeEventArgs bfrSelect = new TreeNodeEventArgs(nextHost.Node, TreeNodeAction.Unknown);
			    if (BeforeSelect != null) BeforeSelect(this, bfrSelect);
			    if (bfrSelect.Cancel) return;
			    setSelectedHost(nextHost);
	    ...
	    private void MultiColumnTree_LostFocus(object sender, System.EventArgs e) { this.Invalidate(); }
	    ...
	    private void MultiColumnTree_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e) {
            ...
            if (e.Button == MouseButtons.Left && _dragBegin) {
                if (e.Location != _startDragPoint) {
                    if (_selectedHost != null) {
                        if (!_selectedNodes.Contains(_selectedHost.Node)) _selectedNodes.Add(_selectedHost.Node);
                    }
                    ...
                    if (DragHelper.ImageList_BeginDrag(_imglDrag.Handle, 0, (int)(_dragBmpSize * 3 / 4), (int)(_dragBmpSize * 3 / 4))) {
                        _dragSource = _selectedHost.Node;
                        DoDragDrop(_selectedHost.Node, DragDropEffects.All);
                    }
	    ...
	    private void MultiColumnTree_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e) {
            ...
            _internalThread = true;
            TreeNode selTn = null;
            if (_selectedHost != null) selTn = _selectedHost.Node;
            if (System.Windows.Forms.Control.ModifierKeys != Keys.Control) _selectedNodes.Clear();
            if (selTn != null) {
                if (!_selectedNodes.Contains(selTn)) _selectedNodes.Add(selTn);
                else if (System.Windows.Forms.Control.ModifierKeys == Keys.Control) _selectedNodes.Remove(selTn);
            }
            _internalThread = false;
            this.Invalidate();
            /*if (_selectedHost != null) {
                if (System.Windows.Forms.Control.ModifierKeys != Keys.Control) {
                    TreeNode tnLast = _selectedHost.Node;
                    _internalThread = true;
                    _selectedNodes.Clear();
                    _selectedNodes.Add(tnLast);
                    _internalThread = false;
                    this.Invalidate();
                }
            }*/
	    ...
	    private void MultiColumnTree_Paint(object sender, System.Windows.Forms.PaintEventArgs e) {
		    ...
		    ColumnHeader[] unfrozenCols = _columnControl.UnFrozenColumns;
		    ColumnHeader[] frozenCols = _columnControl.FrozenColumns;
		    ...
		    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.drawUnFrozen(e.Graphics, frozenCols.Length);
		    if (frozenCols.Length > 0) {
			    ...
			    foreach (TreeNodeHost tnHost in _nodeHosts) tnHost.drawFrozen(e.Graphics, unfrozenCols.Length);
		    }
		    linePen.Dispose();
		    lineBrush.Dispose();
        ...
        private void MultiColumnTree_DragEnter(object sender, DragEventArgs e) {
            DragHelper.ImageList_DragEnter(IntPtr.Zero, e.X - this.Left,
                e.Y - this.Top);
            _dragKeyState = e.KeyState;
            if (_dragBegin) _dragSource = _selectedNodes;
        ...
        private void MultiColumnTree_DragLeave(object sender, EventArgs e) {
        ...
        private void MultiColumnTree_DragOver(object sender, DragEventArgs e) {
            ...
            foreach (TreeNodeHost tnHost in _nodeHosts) {
                if (tnHost.Visible) stateChanged = stateChanged || tnHost.mouseMove(me);
            }
            if (stateChanged) this.Invalidate();
            if (ItemDragMove != null) {
                ItemDragDropEventArgs dde;
                if (_hoverHost != null) dde = new ItemDragDropEventArgs(_dragSource, null, _hoverHost.Node, e.KeyState);
                else dde = new ItemDragDropEventArgs(_dragSource, null, null, e.KeyState);
                ItemDragMove(this, dde);
                e.Effect = dde.Effects;
            }
        }
        private void MultiColumnTree_DragDrop(object sender, DragEventArgs e) {
            bool stateChanged = false;
            ...
            if (ItemDragDrop != null) {
                ItemDragDropEventArgs dde;
                if (_hoverHost != null) dde = new ItemDragDropEventArgs(_dragSource, _hoverHost.Node, _hoverHost.Node, e.KeyState);
                else dde = new ItemDragDropEventArgs(_dragSource, null, null, e.KeyState);
