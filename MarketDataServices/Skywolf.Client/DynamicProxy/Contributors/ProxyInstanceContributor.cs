...
namespace Castle.DynamicProxy.Ref.Contributors
{
	using System;
#if !SILVERLIGHT
	...
	using Castle.DynamicProxy.Ref.Generators;
	using Castle.DynamicProxy.Ref.Generators.Emitters;
	using Castle.DynamicProxy.Ref.Generators.Emitters.CodeBuilders;
	using Castle.DynamicProxy.Ref.Generators.Emitters.SimpleAST;
	using Castle.DynamicProxy.Ref.Internal;
	using Castle.DynamicProxy.Ref.Serialization;
	using Castle.DynamicProxy.Ref.Tokens;
