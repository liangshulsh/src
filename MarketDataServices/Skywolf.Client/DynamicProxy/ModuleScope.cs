...
namespace Castle.DynamicProxy.Ref
{
	...
	public class ModuleScope
	{
		...
		{
			using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Castle.DynamicProxy.Ref.DynProxy.snk"))
			{
				if (stream == null)
				{
					throw new MissingManifestResourceException(
						"Should have a Castle.DynamicProxy.Ref.DynProxy.snk as an embedded resource, so Dynamic Proxy could sign generated assembly");
				}
