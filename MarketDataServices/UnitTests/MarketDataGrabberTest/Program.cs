    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                string smb = "ARNC,AAPL,ABMD,ABT,ADSK,ADBE,ADI,ADM,AEP,AES,AFL,HES,AIG,AMAT,AMD,AME,AMGN,AON,APA,APD,APH,ADP,AXP,AZO,BA,BAC,BAX,BBBY,BBY,BDX,BEN,BK,BLL,BMY,BSX,CAG,CAT,C,CAH,CDNS,CERN,CHD,CI,CL,CLF,CLX,CMA,CMCS_A,CMS,COG,COST,CPB,CSCO,CSX,CTAS,CTL,CMI,CY,D,DE,DHR,DIS,DHI,DTE,DUK,DVN,ECL,ED,EFX,EMR,EOG,EA,ETN,ETR,F,FAST,M,FDX,FISV,FITB,S,NEE,GD,GE,GILD,GIS,GLW,GPS,HAL,MNST,HAS,HBAN,WELL,PEAK,HD,HOLX,HRL,LHX,HSY,HUM,HPQ,IBM,BIIB,IDXX,IFF,INTC,IP,TT,ITW,JNJ,K,KEY,KLAC,KMB,KO,KR,KSS,KSU,LEN,LLY,LOW,LRCX,LB,LUV,MAS,MKC,MCD,MDT,CVS,MGM,SPGI,MMC,MMM,MO,MSI,MRK,MRO,MSFT,MU,MXIM,MYL,NBL,NEM,NI,NKE,JWN,NOC,NSC,NTRS,ES,NUE,OKE,OMC,ORCL,OXY,PAYX,PCAR,PCG,PEG,PEP,PFE,PG,PGR,PH,PHM,PNC,PPG,PPL,QCOM,REGN,ROK,ROP,ROST,RTN,T,SBUX,SCHW,SHW,SLB,SNPS,SO,TRV,STT,SYK,SWK,NLOK,SYY,TER,TIF,TJX,TMO,TROW,TXN,JCI,TSN,UNH,UNP,UTX,VFC,VIAC,VLO,VMC,VRTX,WBA,WDC,WEC,WFC,WHR,WMB,WMT,WY,X,XLNX,XOM,FL,ZBRA,ZION,AGN,CB,INTU,MCHP,ORLY,RCL,RIG,EQR,ATVI,HST,INCY,SPG,MLM,TSCO,ALB,CPRT,BRK_B,SIRI,O,COF,MCK,DLTR,LMT,DRI,LH,DISH,WAB,FCX,EL,NTAP,CTXS,HIG,ALXN,EIX,OLED,ANSS,CHKP,ETFC,DGX,CIEN,KMX,AMTD,IVZ,TTWO,AMZN,TFC,SRPT,MS,PXD,CHRW,NLY,YUM,FE,MTD,URI,VTR,AVB,CTSH,WM,CCI,NVDA,BKNG,GS,SBAC,BMRN,CSGP,AKAM,BLK,WWE,UPS,TGT,EW,MET,ON,MRVL,ILMN,VZ,XEL,LNG,TPR,DVA,EXC,MCO,ALGN,EXAS,GPN,SGEN,ADS,MDLZ,WLTW,FIS,ABC,ZBH,ANTM,CVX,AAP,CNC,PRU,JBLU,NFLX,SWKS,COP,CNP,WYNN,CME,EQIX,STX,CCL,A,AMT,SRE,AEE,PLD,EBAY,RL,ALL,STZ,PSA,JPM,USB,HON,ISRG,ACN,MAR,NRG,CRM,DPZ,IAC,GOOG_L,DLR,LVS,DXCM,MPW,EXPE,CF,AMP,ICE,UAA,LYV,CMG,UAL,TDG,MA,HBI,WU,TMUS,DAL,CLR,PODD,DFS,TEL,BX,LULU,CXO,MELI,VMW,RF,ULTA,MSCI,PM,V,AWK,AGNC,DISC_A,AVGO,VRSK,DG,FTNT,CHTR,SSNC,LYB,TSLA,KKR,NXPI,GM,FRC,FLT,WMGI,KMI,HCA,MOS,YNDX,MPC,VER,APTV,WPX,ZNGA,CZR,ENPH,PSX,SPLK,FB,NOW,FIVE,PANW,WDAY,FANG,RH,ABBV,NCLH,ZTS,IQV,CDW,RNG,BURL,VEEV,TWTR,TNDM,AAL,HLT,ALLY,GRUB,PAYC,ZEN,PE,ANET,INFO,SYF,CFG,W,HUBS,KEYS,QRVO,SHAK,SEDG,GDDY,ETSY,TDOC,KHC,PYPL,LITE,PLNT,HPE,MTCH,SQ,TEAM,FTV,TWLO,TTD,NTNX,COUP,YUMC,AA,INVH,SNAP,DXC,AYX,OKTA,CVNA,VST,ATUS,BKR,DD,ROKU,SPCE,MDB,PAGS,VICI,ZS,DBX,SPOT,DOCU,EVRG,ELAN,GH,ESTC,PLAN,STNE,LIN,DELL,MRNA,FOXA,DOW,LYFT,PINS,ZM,BYND,UBER,CTVA,CRWD,CHWY,WORK,PTON,SPY";
