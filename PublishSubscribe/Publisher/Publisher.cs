...
namespace PublishSubscribe
{
	...
	public class Publisher : System.MarshalByRefObject
	{
        ...
        public void PublishSubName(string name)
        {
            if (OnUpdateSubscrabberName != null)
            {
                OnUpdateSubscrabberName(name);
            }
        }
